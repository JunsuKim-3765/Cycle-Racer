...
function draw() {
  ...
  stroke("white");
  textSize(25);
  text("Press Up arrow to restart the game", 260, 200);
...
function reset(){
        gameState=PLAY;
        gameOver.visible=false;
        //mainCyclist.addAnimation("images/mainPlayer2.png");
        pinkCG.destroyEach();
